...
find_space_loop:
        movzbl  (%ecx, %esi), %edx         # Add in the count, then move
        add     %edx, %ebx                   # (In case of overflow, add to bh)
